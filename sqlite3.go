...
/* COPIED FROM: https://github.com/rsc/sqlite as a temporary sqlite3 drive for development*/
...
// 	var db *C.sqlite3
// 	C.sqlite3_open(C.CString(name), &db)
// 	return &conn{db: db}, nil
// }
...
// 	var emsg *C.char
// 	C.sqlite3_prepare_v2(c.db, C.CString(query), -1, &stmt, &emsg)
